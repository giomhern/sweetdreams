                ...
                <div className="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2">
                    <div className="flex flex-col items-center justify-center text-center">
                        <span className="p-5 text-sweetblue rounded-full bg-blue-100/80">
                            <svg className="md:h-[2em] md:w-[2em] h-[1em] w-[1em]" xmlns="http://www.w3.org/2000/svg" fill="none" height="2em"  width="2em" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
