                ...
                <div className="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2">
                    <div className="flex flex-col items-center justify-center text-center">
                        <span className="p-5 text-sweetblue rounded-full bg-blue-100/80">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" height="3em"  width="3em" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
                    ...
                    <div className="flex flex-col items-center justify-center text-center">
                        ...
                        <p className="mt-2 text-sweetblue">+1 (555) 000-0000</p>
                    </div>
                </div>
            </div>
        </section>
