...
const About = () => {
    return (
        <div id='about' className="md:px-8 md:py-10 md:grid md:grid-cols-2 md:space-x-10 lg:h-[45em] md:justify-center md:items-center flex flex-col justify-center items-center px-5 md:h-[38em] h-[35em] ">
