...
const About = () => {
    return (
        <div id='about' className="md:px-8 md:py-10 md:grid md:grid-cols-2 md:space-x-10 md:h-[40em] md:justify-center md:items-center flex flex-col justify-center items-center px-5 h-96">
