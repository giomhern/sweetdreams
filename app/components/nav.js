                ...
                <nav className={`flex transition-opacity duration-500 ease-in-out justify-between md:py-4 px-5 py-3 md:px-10 fixed z-10 bg-transparent w-full ${isVisible ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
                    <div className='flex md:space-x-5 space-x-2 items-center justify-center text-gray-400'>
                        ...
                        <div className='flex items-center'>
                            <a href="tel:+19099059441" className='items-center justify-center border-aliceblue text-aliceblue md:border-lightcyan md:text-lightcyan  rounded-full md:border-2 border md:px-5 md:py-2 md:text-xl text-md px-3 py-1 hover:text-cyanblue hover:border-lightcyan hover:bg-lightcyan hover:cursor'>
                                Book Now
                            </a>
                        </div>
                </nav>: null
