        ...
        <div>
            <nav className="flex justify-between md:py-4 px-5 py-3 md:px-10  w-full">
                <div className='flex md:space-x-5 space-x-2 items-center justify-center'>
                    <Link href="/"><img className='h-[60px] w-[60px] md:h-[100px] md:w-[100px] ' src='./SWEETDREAMS.png' height="80px" width="80px" alt='this is the logo'></img></Link> 
                    ...
                    <Link href="#contact"><p className="font-thin md:visible invisible text-aliceblue md:text-xl text-xs hover:text-cyanblue">Contact</p></Link>
                </div>
